# -*- coding: utf-8 -*-
# Generated by Django 1.11.13 on 2018-06-23 09:33
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('tunga_projects', '0005_auto_20180621_0509'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='document',
            name='type',
            field=models.CharField(choices=[(b'estimate', b'Estimate'), (b'proposal', b'Proposal'), (b'planning', b'Planning'), (b'requirements', b'Requirements Document'), (b'wireframes', b'Wireframes'), (b'timeline', b'Timeline'), (b'other', b'Other')], default=b'other', max_length=30),
        ),
        migrations.AlterField(
            model_name='project',
            name='skills',
